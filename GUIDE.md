...
To install the repository go to “Settings” → “Add-ons” → “Install from zip file”. Navigate to you Home folder where you downloaded the file solbero.repository-1.0.1.zip.
